        ...
        <div className="container mx-auto p-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <Image src="https://img1.wsimg.com/isteam/ip/3458a644-d186-438f-9ee3-59650cd81b43/gita.jpg/:/cr=t:0%25,l:0%25,w:100%25,h:100%25" alt="Bhagavad Gita" width={500} height={375} objectFit="cover" className="rounded-lg shadow-lg" />
            </div>
            <div className="md:w-1/2 md:pl-8">
              <h2 className="text-3xl font-semibold mb-4 text-gray-800">Help Our Cause</h2>
              <p className="text-lg mb-6 text-gray-600">Your support and contributions will enable us to meet our goals and fund our mission.</p>
