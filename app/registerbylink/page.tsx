...
const AttendancePage = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col">
            ...
            <>
              ...
              {name ? (
                <div className="text-center">
                  ...
                  <button onClick={handleMarkAttendance} disabled={isMarkingAttendance} className="w-full bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed">
                    {isMarkingAttendance ? (
              ...
              <button onClick={() => setShowRegistrationForm(true)} className="w-full mt-4 bg-gray-600 text-white px-6 py-2 rounded hover:bg-gray-700 transition duration-300">
      ...
      {showRegistrationForm && <RegistrationForm onClose={() => setShowRegistrationForm(false)} isAttendancePage={false} onSuccess={handleRegistrationSuccess} />}
    </div>
  );
};
