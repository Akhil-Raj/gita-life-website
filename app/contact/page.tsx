    ...
    <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto p-8">
        ...
        <div className="bg-white shadow-lg rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-center text-gray-800">Follow Us</h2>
        ...
        <div className="bg-white shadow-lg rounded-lg p-8 mb-8">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8 mb-8">
            ...
            <a href="tel:+19296310021" 
              ...
              <span>Call +1 (929) 631-0021 (Sachin)</span>
            </a>
          </div>

          <div className="text-center mb-8">
            <h2 className="text-2xl font-semibold mb-2 text-gray-800">GitaLifeNYC</h2>
            <p className="flex justify-center items-center text-gray-600 mb-4">
